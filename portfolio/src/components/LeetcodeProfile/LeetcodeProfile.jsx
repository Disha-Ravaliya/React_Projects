    ...
    return (
        <div className="min-h-screen w-full   px-4 py-10 md:px-10 flex flex-col lg:flex-row gap-8 items-start ">
            ...
            <div className="w-full lg:w-[450px] flex flex-col gap-6 shrink-0">
                {/* scoreContainer */}
                <div className="rounded-2xl border border-neutral-800 bg-neutral-900/40 p-6 backdrop-blur-md flex flex-wrap flex-row justify-start gap-y-6 gap-x-4 sm:gap-x-8 text-white pointer-events-auto">
                ...
                {/* trackContainer */}
                <div className="rounded-2xl border border-neutral-800 bg-neutral-900/40 p-6 backdrop-blur-md flex flex-col gap-y-6 pointer-events-auto text-white">
